...
def get_parser():
    ...
    parser.add_argument("--tar-key-word1", type=str, default=None, help="the key word to find file from tar")
    parser.add_argument("--tar-key-word2", type=str, default=None, help="the key word to find file from tar")
    parser.add_argument("--tar-info1", type=str, default=None, help="the file to save tar information")
    parser.add_argument("--tar-info2", type=str, default=None, help="the file to save tar information")
    ...
    parser.add_argument("--output-file1", type=str, help="dict")
    parser.add_argument("--output-file2", type=str, help="dict")
    parser.add_argument("--tokenizer", type=str, choices=['audio', 'g2p', 'bpe', 'clipbpe', 'semantic', 'encodec', 'alignment'], help="what tokenizer to use")
    ...
    if args.input_file is not None:
        ...
        for i, line in enumerate(open(args.tar_file,'r')):
            ...
            for info in tar_o: # get the speech info
                ...
                if info.name.split(".")[-1] == args.tar_key_word1:
                ...
                if info.name.split(".")[-1] == args.tar_key_word2:
                    key = ' '.join(info.name.split(".")[:-1]) # 
